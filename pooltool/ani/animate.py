...
class Game(Interface):
    ...
    def __init__(self, config=ShowBaseConfig.default()):
        ...
        Global.mode_mgr.update_event_baseline()
        tasks.add_later(0.1, self._auto_start_game, "auto_start_game")

    def _auto_start_game(self, task):
        self._enter_game()
        return task.done
    ...
    def _open_settings(self):
        """Close the active game and open the settings-driven game setup menu."""
        self.close_scene()
